...
document.addEventListener('DOMContentLoaded', function() {
    ...
    loadDashboardStats(); loadAdminArticles(); loadAdminPrograms(); loadAdminClients();
    loadAdminTranslations(); loadAdminStatus(); loadAdminToefl();
    setTimeout(function() { updateSmallPreview('trans'); updateSmallPreview('toefl'); }, 800);
});
...
function handleFilePreview(input, type) {
    ...
    if (type === 'trans') transFileData = f; else toeflFileData = f;
    ...
    var sm = document.getElementById(type + 'SmallPreview');
